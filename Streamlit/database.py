...
def insert_entry(username,date,name,place,mailid,other,lof):
    if(lof=="lost"):
        return ldb.put({"date": date,"name": name,"place": place,"email":mailid,"username":username,"other": other,"status":""})
    else:
        return rdb.put({"date": date,"name": name,"place": place,"email":mailid,"username":username,"other": other,"status":""})
